...
public class Company_registration extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Fill all these fields then click SAVE COMPANY button.");

        jLabel13.setFont(new java.awt.Font("Yu Gothic UI", 0, 12)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(153, 153, 153));
        jLabel13.setText("After that you can save company to system.");
        ...
        jLabel15.setText("Double-Click to select company using this table.");
        ...
        jLabel17.setText("UPDATE or DELETE company.");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION) {
            try {
                ...
                MySql.iud("DELETE FROM `company` WHERE `id`='" + company_id + "'");
                resetFields();
                loadCompanies();
        ...
        if (name.isEmpty()) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    String company_id = "COM-" + String.format("%06d", number);

                    MySql.iud("INSERT INTO `company` (`id`,`name`,`contact_number`) VALUES ('" + company_id + "','" + name + "','" + contact_number + "')");
                    resetFields();
                    loadCompanies();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (name.isEmpty()) {
            ...
            try {
                ...
                MySql.iud("UPDATE `company` SET `company`.`name`='" + name + "',`company`.`contact_number`='"+contact_number+"' WHERE `id`='" + company_id + "'");

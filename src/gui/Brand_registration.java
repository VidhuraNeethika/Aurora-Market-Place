...
public class Brand_registration extends javax.swing.JPanel {
    ...
    public void loadBrands(String text) {
        try {
            ...
            ResultSet rs = MySql.search("SELECT * FROM `brand` WHERE `brand`.`name` LIKE '" + text + "%' ORDER BY `name` ASC");
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
    ...
    private void initComponents() {
        ...
        jButton15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/small-brand.png"))); // NOI18N
        ...
        jLabel12.setText("Fill all these fields then click SAVE BRAND button.");

        jLabel13.setFont(new java.awt.Font("Yu Gothic UI", 0, 12)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(153, 153, 153));
        jLabel13.setText("After that you can save brand to system.");
        ...
        jLabel17.setText("UPDATE or DELETE brand.");
        ...
        jTextField2.setText("Search Brand");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int r = jTable1.getSelectedRow();
        String brand_id = jTable1.getValueAt(r, 0).toString();
        ...
        if (option == JOptionPane.YES_OPTION) {
            try {
                ...
                MySql.iud("DELETE FROM `brand` WHERE `id`='" + brand_id + "'");
                resetFields();
                loadBrands();
    ...
    private void jTextField2FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField2FocusGained
        ...
        if (jTextField2.getText().equals("Search Brand")) {
            jTextField2.setText("");
        ...
        if (name.isEmpty()) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    String brand_id = "BND-"+String.format("%06d", number);

                    MySql.iud("INSERT INTO `brand` (`id`,`name`) VALUES ('"+brand_id+"','" + name + "')");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (name.isEmpty()) {
            ...
            try {
                ...
                MySql.iud("UPDATE `brand` SET `brand`.`name`='" + name + "' WHERE `id`='" + brand_id + "'");

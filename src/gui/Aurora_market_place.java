 ...
 * @author DELL
 */
public class Aurora_market_place extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setFont(new java.awt.Font("Yu Gothic UI", 0, 13)); // NOI18N
        ...
        jButton16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/small-product.png"))); // NOI18N
        ...
        jButton17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/small-brand.png"))); // NOI18N
        jButton17.setBorderPainted(false);
        jButton17.setContentAreaFilled(false);

        jButton13.setFont(new java.awt.Font("Yu Gothic UI", 0, 13)); // NOI18N
        jButton13.setText("Brand Registration");
        ...
        jButton18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/small-category.png"))); // NOI18N
        jButton18.setBorderPainted(false);
        jButton18.setContentAreaFilled(false);

        jButton14.setFont(new java.awt.Font("Yu Gothic UI", 0, 13)); // NOI18N
        jButton14.setText("Category Registration");
        jButton14.setBorderPainted(false);
        jButton14.setContentAreaFilled(false);
        jButton14.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jButton14.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        jButton14.setMargin(new java.awt.Insets(2, 0, 2, 14));
            ...
            .addGroup(kGradientPanel7Layout.createSequentialGroup()
                ...
                .addGroup(kGradientPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(kGradientPanel7Layout.createSequentialGroup()
                        ...
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(chart, javax.swing.GroupLayout.DEFAULT_SIZE, 694, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        kGradientPanel8Layout.setVerticalGroup(
            ...
            .addGroup(kGradientPanel8Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(polarAreaChart, javax.swing.GroupLayout.DEFAULT_SIZE, 275, Short.MAX_VALUE)
                .addContainerGap())
        );
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jPanel4, javax.swing.GroupLayout.DEFAULT_SIZE, 868, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Manage_product pr = new Manage_product();
        jPanel4.removeAll();
        jPanel4.add(pr);
        jPanel4.revalidate();
        jPanel4.repaint();
        jLabel16.setText("Manage Products");
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed

        Brand_registration br = new Brand_registration();
        jPanel4.removeAll();
        jPanel4.add(br);
        jPanel4.revalidate();
        jPanel4.repaint();
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        ...
        jPanel4.revalidate();
        jPanel4.repaint();
        jLabel16.setText("Category Registration");
    ...
    private void jButton13FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jButton13FocusLost
        ...
        jButton13.setFont(new Font("Yu Gothic Ui", Font.PLAIN, 13));
    ...
    private void jButton14FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jButton14FocusGained
        ...
        jButton14.setFont(new Font("Ebrima", Font.BOLD, 13));
    ...
    private void jButton14FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jButton14FocusLost
        ...
        jButton14.setFont(new Font("Yu Gothic Ui", Font.PLAIN, 13));
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        if (text.equals("Dashboard")) {
            ...
            jPanel4.repaint();
            jLabel16.setText("Manage Users");
        } else if (text.equals("Manage Products")) {
            Manage_product pr = new Manage_product();
            jPanel4.removeAll();
            jPanel4.add(pr);
            jPanel4.revalidate();
            jPanel4.repaint();
            jLabel16.setText("Manage Products");
        } else if (text.equals("Brand Registration")) {
            Brand_registration br = new Brand_registration();
            jPanel4.removeAll();
            jPanel4.add(br);
            jPanel4.revalidate();
            jPanel4.repaint();
            jLabel16.setText("Brand Registration");
        } else if (text.equals("Category Registration")) {
            Category_registration cr = new Category_registration();
            jPanel4.removeAll();
            jPanel4.add(cr);
            jPanel4.revalidate();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Aurora_market_place().setVisible(true);
            }
        });
    }

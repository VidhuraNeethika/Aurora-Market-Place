...
public class Select_product extends javax.swing.JDialog {
    ...
    public Select_product(GRN parent, boolean modal) {
        initComponents();
        this.grn = parent;
        loadProducts();
        tableDesign();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (r == -1) {
                ...
                grn.jTextField9.setText(jTable1.getValueAt(r, 0).toString());
                grn.jTextField10.setText(jTable1.getValueAt(r, 1).toString());
                grn.jTextField11.setText(jTable1.getValueAt(r, 2).toString());
                grn.jTextField12.setText(jTable1.getValueAt(r, 3).toString());

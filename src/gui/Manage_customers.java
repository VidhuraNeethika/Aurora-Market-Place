...
public class Manage_customers extends javax.swing.JPanel {
    ...
    public void tableDesign() {
        ...
        table_header.setFont(new Font("Yu Gothic Ui", Font.BOLD, 14));
         ...
         for (int i = 0; i < jTable1.getColumnCount(); i++) {
            jTable1.getColumnModel().getColumn(i).setCellRenderer(centerAlignment);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Fill all these fields then click SAVE CUSTOMER button.");

        jLabel13.setFont(new java.awt.Font("Yu Gothic UI", 0, 12)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(153, 153, 153));
        jLabel13.setText("After that you can save customer to system.");
        ...
        jLabel17.setText("DEACTIVATE or DELETE customer.");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION) {
            try {
                ...
                MySql.iud("DELETE FROM `customer` WHERE `id`='" + customer_id + "'");
                resetFields();
                loadCustomers();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String customer_contact_number = jTextField4.getText();
        String city = jComboBox1.getSelectedItem().toString();

        if (customer_name.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please enter customer name", "Warning", JOptionPane.WARNING_MESSAGE);
        } else if (customer_contact_number.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please enter customer contact number", "Warning", JOptionPane.WARNING_MESSAGE);
            ...
            try {
                ResultSet rs = MySql.search("SELECT * FROM `customer` WHERE `name`='" + customer_name + "'");
                ...
                if (rs.next()) {
                    ...
                    String customer_id = "CUS-" + String.format("%06d", number);
                    ...
                    MySql.iud("INSERT INTO `customer` (`id`,`name`,`contact_number`,`city_id`) VALUES ('" + customer_id + "','" + customer_name + "','" + customer_contact_number + "','" + city_id + "')");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            MySql.iud("UPDATE `customer` SET `status_id`=" + status + " WHERE `id`='" + customer_id + "'");
